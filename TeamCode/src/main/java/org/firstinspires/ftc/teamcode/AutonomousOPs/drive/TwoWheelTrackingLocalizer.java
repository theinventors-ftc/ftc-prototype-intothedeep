...
import org.firstinspires.ftc.teamcode.AutonomousOPs.util.Encoder;
...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_X = -4.85;
    public static double PERPENDICULAR_Y = 0.0;

    public static double X_MULTIPLIER = 0.99840371409; // Multiplier in the X direction
